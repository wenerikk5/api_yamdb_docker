...
def user_auth(request):
    ...
    serializer.is_valid(raise_exception=True)
    print("=====IN USER_AUTH before get_404...=====")
    user = get_object_or_404(
        CustomUser,
        username=serializer.validated_data['username']
    )
    print('user: ', user)
    print("=====BEFORE check of conf code====")
    print(user.confirmation_code, serializer.validated_data['confirmation_code'])
...
class TitleViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        request.data['genre'] = [{"name": "name", "slug": "slug"}] # to pass validation for genre
